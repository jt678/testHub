 ...
 * 登录策略工厂1，在这里根据type得到对应的实例，调用不通的处理逻辑
 *
 ...
 */
@Component
public class LoginStrategyFactory1 implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        //ComponentScan注解扫描到的bean，class会立刻被解析成BeanDefinition，添加进BeanDefinitionNames属性中，这里相当于手动去拿spring中所有加载好的bean
